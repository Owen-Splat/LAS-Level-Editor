...
## ==> GUI FILE
# from LevelEditorUI.Window.main import MainWindow
from PySide6 import QtCore, QtGui, QtWidgets

# IMPORT QSS CUSTOM
from LevelEditorUI.Window.ui_styles import Style

# IMPORT NEEDED ICONS
from LevelEditorCore.Data.data import RESTORE_ICON, MAXIMIZE_ICON
...
class UIFunctions():
    ...
    def maximize_restore(self):
        ...
        if status == 0:
            ...
            self.ui.btn_maximize_restore.setIcon(QtGui.QIcon(RESTORE_ICON))
    ...
    def addNewMenu(self, name, objName, icon, isTopMenu):
        ...
        button = QtWidgets.QPushButton(str(count),self)
        button.setObjectName(objName)
        sizePolicy3 = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        button.setFont(font)
        button.setStyleSheet(Style.style_bt_standard.replace('ICON_REPLACE', f"url({icon})"))
        button.setText(name)
