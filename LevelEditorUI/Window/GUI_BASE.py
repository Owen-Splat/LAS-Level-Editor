...
"}")
        ...
        self.projectNameLabel = QLabel(self.page_home)
        self.projectNameLabel.setObjectName(u"projectNameLabel")
        font5 = QFont()
        font5.setFamilies([u"Segoe UI"])
        font5.setPointSize(14)
        self.projectNameLabel.setFont(font5)
        self.projectNameLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_10.addWidget(self.projectNameLabel)

        self.horizontalLayout_15 = QHBoxLayout()
        self.horizontalLayout_15.setObjectName(u"horizontalLayout_15")
        self.projectNameEdit = QLineEdit(self.page_home)
        self.projectNameEdit.setObjectName(u"projectNameEdit")

        self.horizontalLayout_15.addWidget(self.projectNameEdit)
        ...
        self.romEdit = QLineEdit(self.page_home)
        self.romEdit.setObjectName(u"romEdit")

        self.horizontalLayout_13.addWidget(self.romEdit)

        self.romBrowseButton = QPushButton(self.page_home)
        self.romBrowseButton.setObjectName(u"romBrowseButton")

        self.horizontalLayout_13.addWidget(self.romBrowseButton)
        ...
        self.outEdit = QLineEdit(self.page_home)
        self.outEdit.setObjectName(u"outEdit")

        self.horizontalLayout_14.addWidget(self.outEdit)

        self.outBrowseButton = QPushButton(self.page_home)
        self.outBrowseButton.setObjectName(u"outBrowseButton")

        self.horizontalLayout_14.addWidget(self.outBrowseButton)
        ...
        self.newButton = QPushButton(self.page_home)
        self.newButton.setObjectName(u"newButton")

        self.horizontalLayout_16.addWidget(self.newButton)

        self.openButton = QPushButton(self.page_home)
        self.openButton.setObjectName(u"openButton")

        self.horizontalLayout_16.addWidget(self.openButton)

        self.saveButton = QPushButton(self.page_home)
        ...
        self.verticalLayout_6 = QVBoxLayout(self.page_location)
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.horizontalLayout_9 = QHBoxLayout()
        self.horizontalLayout_9.setObjectName(u"horizontalLayout_9")
        self.levelList = QListWidget(self.page_location)
        self.levelList.setObjectName(u"levelList")

        self.horizontalLayout_9.addWidget(self.levelList)

        self.levelLayoutArea = QScrollArea(self.page_location)
        self.levelLayoutArea.setObjectName(u"levelLayoutArea")
        self.levelLayoutArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 616, 578))
        self.gridLayout_2 = QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.levelGridLayout = QGridLayout()
        self.levelGridLayout.setObjectName(u"levelGridLayout")

        self.gridLayout_2.addLayout(self.levelGridLayout, 0, 0, 1, 1)

        self.levelLayoutArea.setWidget(self.scrollAreaWidgetContents)

        self.horizontalLayout_9.addWidget(self.levelLayoutArea)

        self.horizontalLayout_9.setStretch(1, 1)

        self.verticalLayout_6.addLayout(self.horizontalLayout_9)

        self.stackedWidget.addWidget(self.page_location)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Project Manager", None))
        self.projectNameLabel.setText(QCoreApplication.translate("MainWindow", u"Project Name", None))
        self.projectNameEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Project Name", None))
        self.romEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"RomFS Path", None))
        self.romBrowseButton.setText(QCoreApplication.translate("MainWindow", u"Browse", None))
        self.outEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Output Path", None))
        self.outBrowseButton.setText(QCoreApplication.translate("MainWindow", u"Browse", None))
        self.newButton.setText(QCoreApplication.translate("MainWindow", u"New Project", None))
        self.openButton.setText(QCoreApplication.translate("MainWindow", u"Open Project", None))
        self.saveButton.setText(QCoreApplication.translate("MainWindow", u"Save Project", None))
